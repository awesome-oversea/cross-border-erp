...
import type {
  ...
  AlertRule, ReportDefinition, KpiMetric, CockpitTrend, RankingData, DashboardMetrics,
...
export const crmApi = {
  ...
  listTickets: (params?: PageParams & Record<string, unknown>) => getPage<ServiceTicket>('/crm/api/in/v1/tickets', params),
  ...
  listEmailRules: (params?: PageParams) => getPage<EmailRule>('/crm/api/in/v1/email-rules', params),
  ...
  listEmailCampaigns: (params?: PageParams) => getPage<EmailCampaign>('/crm/api/in/v1/email-campaigns', params),
