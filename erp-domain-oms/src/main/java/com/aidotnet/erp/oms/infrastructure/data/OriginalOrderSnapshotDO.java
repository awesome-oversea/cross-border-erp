...
@TableName("oms_original_order")
public class OriginalOrderSnapshotDO {
    ...
    public String getDuplicateOrderId() {
        return duplicateOrderId;
    }

    public void setDuplicateOrderId(String duplicateOrderId) {
